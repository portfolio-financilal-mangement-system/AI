...
def make_usd_to_egp_predictions():
    # Get the absolute path to the model file
    model_path = os.path.join(os.path.dirname(__file__), 'USD_to_EGP_model.pkl')
    ...
    data_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'processed', 'USD_to_EGP_exchange_rate_preprocessed.csv')
    ...
    # Predict the next 5 days' exchange rates
