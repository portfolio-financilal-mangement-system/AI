...
def make_msft_predictions():
    # Get the absolute path to the model file
    model_path = os.path.join(os.path.dirname(__file__), 'MSFT_model.pkl')
    ...
    data_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'processed', 'MSFT_historical_stock_prices_preprocessed.csv')
